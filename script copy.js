...
function togglePasswordVisibility(inputId, eyeIconId) {
    ...
    if (passwordField.type === 'password') {
        ...
        eyeIcon.src = './assest/img/eye-off.png'; // Path to eye-off icon for visibility off state "./assets/img/eye-off.png" 
    } else {
        passwordField.type = 'password';
        eyeIcon.src = './assest/img/eye-on.png'; // Path to eye icon for visibility on state
    }
}
